...
static const char * TAG = "BLEProvisionMainApp";

esp_ble_adv_data_t BLEProvisionMainApp::esp_ble_adv_data = { 0 };
esp_ble_adv_params_t BLEProvisionMainApp::esp_ble_adv_params = { 0 };
ble_onboarding_profile_t BLEProvisionMainApp::ble_onboarding_profile = { 0 };
service_config_t BLEProvisionMainApp::wifi_scan_service = { 0 };
characteristics_config_t BLEProvisionMainApp::wifi_scan_service_char_1 = { 0 };
characteristics_config_t BLEProvisionMainApp::wifi_scan_service_char_2 = { 0 };
characteristics_config_t BLEProvisionMainApp::wifi_scan_service_char_3 = { 0 };
service_config_t BLEProvisionMainApp::wifi_config_service = { 0 };
characteristics_config_t BLEProvisionMainApp::wifi_config_service_char_1 = { 0 };
characteristics_config_t BLEProvisionMainApp::wifi_config_service_char_2 = { 0 };

uint8_t BLEProvisionMainApp::adv_service_uuid128[32] = {
...
BLEProvisionMainApp::BLEProvisionMainApp()
{

}

void BLEProvisionMainApp::Init()
{
#if defined(ARDUINO_ARCH_ESP32)
...
void BLEProvisionMainApp::Deinit()
{
...
void BLEProvisionMainApp::SetName(std::string name)
{
    mName = name;
...
void BLEProvisionMainApp::BLEGAPConfigure()
{
...
void BLEProvisionMainApp::Start()
{
