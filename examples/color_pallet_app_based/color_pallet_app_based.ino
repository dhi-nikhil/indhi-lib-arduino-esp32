...
#define FEATURE_1_NAME "Color Light"

feature_status_t colorLight_callback(char *feature_id, int data)
{
...
ErrorCode_t device_onboard(void)
{
    ...
    indhilib_add_color_pallet(FEATURE_1_ID, FEATURE_1_NAME, 1, colorLight_callback);
...
void setup()
{
    ...
    Serial.println("Color light example with indhi");
    xTaskCreate(reset_button_task, "reset_button_task", 4096, NULL, 5, NULL);

    /* Color initialized here */
