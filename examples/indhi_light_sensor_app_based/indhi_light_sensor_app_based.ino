...
#define FEATURE_1_NAME "intensity"
...
void lightSensor(void *arg)
{
    while (true)
    {
        indhilib_send_data((char *)FEATURE_1_ID, esp_random() % 1760);
...
void myTask(void *arg)
{
    ...
    if (ErrorCode == ESP_OK)
    {
        ...
        xTaskCreate((TaskFunction_t)lightSensor, "lightSensor", 4096, NULL, 5, NULL);
        messaging_init();
        messaging_start();
    }
    else
